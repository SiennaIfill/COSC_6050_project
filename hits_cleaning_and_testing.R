...
hits <- subset(scout_team_plays, select = c(Name, attack_code,AttackPlay, evaluation_code, start_zone, end_zone, skill_subtype, Phase)) 
...
scout_player_hits <- filter(hits, Name == "Isabela Haggard")
#get kill pct
...
if(top_4[[1,1]]=="Setter Dump"){
  top1_shot <- paste("A",top_4[[1,1]],"to zone",top_4[[1,3]])
  top1_all <- scout_player_hits |> filter(AttackPlay==top_4[[1,1]],end_zone==top_4[[1,3]])
  ...
  top2_shot <- paste("A",top_4[[2,1]],"to zone",top_4[[2,3]])
  top2_all <- scout_player_hits |> filter(AttackPlay==top_4[[2,1]],end_zone==top_4[[2,3]])
  ...
  top3_shot <- paste("A",top_4[[3,1]],"to zone",top_4[[3,3]])
  top3_all <- scout_player_hits |> filter(AttackPlay==top_4[[3,1]],end_zone==top_4[[3,3]])
  ...
  top4_shot <- paste("A",top_4[[4,1]],"to zone",top_4[[4,3]])
  top4_all <- scout_player_hits |> filter(AttackPlay==top_4[[4,1]],end_zone==top_4[[4,3]])
